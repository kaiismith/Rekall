...
const (
	...
	// Kat live notes (running summary + key points + open questions). Notes are
	// generated by the Kat scheduler against a sliding window of finalized
...
type OutboundMessage struct {
	...
	// Generic data envelope used by message types whose payload is a
	// self-contained DTO (e.g. kat.note). Marshalled inline by callers so the
	// outbound JSON shape is `{ "type": "...", "data": {...} }`.
